...
process PLOT_CHR_MANTA_FREEC {
  ...
  script:
    """
    mkdir ${meta.sample}
    figeno_plotchr.py --freec_ratios ${ratios} --freec_cnv ${cnv} --sv ${sv_vcf} --sex ${meta.sex} -o ${meta.sample}/${meta.sample} --format png 
    """
}
...
process PLOT_CIRCOS_MANTA_FREEC {
  ...
  script:
    """
    figeno_plotcircos.py --freec_ratios ${ratios} --freec_cnv ${cnv} --sv ${sv_vcf} --sex ${meta.sex} -o ${meta.sample}_circos.png
    """
