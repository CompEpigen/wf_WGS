...
include { AMBER_CONTROL as AMBER } from '../modules/local/amber'
include { COBALT_CONTROL as COBALT } from '../modules/local/cobalt'
include { GRIDSS_CONTROL as GRIDSS} from '../modules/local/gridss'
include { GRIPSS_CONTROL as GRIPSS } from '../modules/local/gripss'
include { PURPLE_CONTROL as PURPLE; PURPLE_FILTER_CONTROL as PURPLE_FILTER; MERGE_PURPLE_RESULTS} from '../modules/local/purple'
...
workflow WGS_CONTROL{
  ...
  GRIPSS(GRIDSS.out,ref_fa,ref_fai,gripss_pon_sgl, gripss_pon_sv, gripss_repeat_mask,hmf_ref_genome_version)
  ...
  PURPLE_FILTER(PURPLE.out.output)
